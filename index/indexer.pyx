...
cdef class Sort_hits:
    ...
    cdef sort_wid(self,char *fdir,int index):
        ...
        hitSort.sort_in_wid(0,self.length)
            ...
            if self.hit_list[i].wordID == cur_wid:
                ...
                while j < i:
                    ...
                    if self.hit_list[j].docID == cur_did:
                        ...
                        self.hitsort.sort_sco(cur_sco_step,j-1,j-cur_sco_step)
                        cur_sco_step = j
